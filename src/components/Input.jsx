  ...
  return (
    <div className="mb-4">
      ...
      {label && (
        <label
          htmlFor="{name}"
          className="block text-sm font-medium text-gray-700 mb-1 dark:text-gray-300 mb-1"
        >
          {label}
      ...
      <input
        ...
        className={`
          ...
          placeholder-gray-400 dark:placeholder-gray-500 ${error ? 'border-red-500' : 'border-gray-300'
        }`}
      />
